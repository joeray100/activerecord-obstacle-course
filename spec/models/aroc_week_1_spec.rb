...
# ----------------------
  ...
  it '1. finds orders by amount' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_500 = Order.find_orders(500)
    orders_of_200 = Order.find_orders(200)
    # ------------------------------------------------------------
  ...
  it '4. finds orders of multiple amounts' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      orders_of_500_and_700 = Order.find_multiple_orders(500, 700)
      orders_of_700_and_1000 = Order.find_multiple_orders(700, 1000)
    # ------------------------------------------------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      orders = Order.find_multiple_orders_by_id(ids_to_find)
    # ------------------------------------------------------------
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      orders_between_700_and_1000 = Order.find_orders_by_amount_range
    # ------------------------------------------------------------
